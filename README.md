...
[![Resume](https://img.shields.io/badge/Resume-Download-brightgreen?style=for-the-badge&logo=readthedocs)](https://abhlshekkgupta.web.app/)
...
I embed with Fortune 500 analytics teams to build the AI infrastructure that 
actually ships — production systems that generate 
measurable revenue impact and cost reduction.

### Current & Recent Engagements

| Engagement Context | System Built | Impact Category |
|-------------------|--------------|-----------------|
| Fortune 50 Retail | Multi-agent inventory optimization with GenAI decision layer | Supply Chain — $100M+ waste reduction |
| Fortune 50 Healthcare | RAG system over 50M+ clinical documents | Clinical Intelligence — 40% faster retrieval |
| Fortune 50 Insurance | Computer vision claims processing pipeline | Operations — 60% processing time reduction |
| Fortune 50 Tech | Enterprise knowledge graph with LLM-powered querying | Internal Tools — 10K+ employees served |
...
![LlamaIndex](https://img.shields.io/badge/LlamaIndex-8A2BE2&logoColor=white)
...
![Triton Inference](https://img.shields.io/badge/Triton_Inference-76B900?logo=nvidia&logoColor=white)
